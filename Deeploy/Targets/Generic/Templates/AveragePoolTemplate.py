...
class _AveragePool2DTemplate(NodeTemplate):
...
referenceTemplate = _AveragePool2DTemplate("""
<%
batchOffsetIn = ch_im_in * dim_im_in_x * dim_im_in_y
batchOffsetOut = ch_im_out * dim_im_out_x * dim_im_out_y
poolSize = dim_kernel_x * dim_kernel_y
%>

// 2D AveragePool (Name: ${nodeName}, Op: ${nodeOp})
BEGIN_SINGLE_CORE
    ${data_in_type.typeName} ref_${data_out}_${data_in} = ${data_in};
    ${data_out_type.typeName} ref_${data_out}_${data_out} = ${data_out};

    for (uint32_t n=0; n<${batch}; ++n) {
        AvgPool2d_s${data_in_type.referencedType.typeWidth}_s${data_out_type.referencedType.typeWidth}_NCHW(
            ref_${data_out}_${data_in}, ${ch_im_in}, ${dim_im_in_x}, ${dim_im_in_y},
            ${dim_kernel_x}, ${dim_kernel_y}, ${stride_x}, ${stride_y}, ${poolSize},
...
floatReferenceTemplate = _AveragePool2DTemplate("""
<%
batchOffsetIn = ch_im_in * dim_im_in_x * dim_im_in_y
batchOffsetOut = ch_im_out * dim_im_out_x * dim_im_out_y
poolSize = dim_kernel_x * dim_kernel_y
